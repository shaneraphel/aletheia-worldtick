...
CSV = Path(__file__).resolve().parent / "resources" / "synthetic" / "tape_hitachi.csv"
LOCK = "bloomlock"
N = 3
...
def main():
    ...
    rec = {
        ...
        "built": "official MNE reads Hitachi onsets [1,2,3] on S1_D1 695; empty Hitachi is absence",
        "theirs": theirs(),
        "ours": {
