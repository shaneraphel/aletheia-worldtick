# Show: pybloom-live (the empty filter)

Compared with [joseph-fox/python-bloomfilter](https://github.com/joseph-fox/python-bloomfilter)
...
# Show: PhysioNet wfdb on the key tape
