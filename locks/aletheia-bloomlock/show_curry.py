...
DAP = Path(__file__).resolve().parent / "resources" / "synthetic" / "tape_curry.dap"
LOCK = "bloomlock"
N = 3
...
def main():
    ...
    rec = {
        ...
        "built": "official MNE reads Curry onsets [1,2,3] on Cz and event 1/2 at 1.0/2.0 s; empty Curry is absence",
        "theirs": theirs(),
        "ours": {
            "n": n,
