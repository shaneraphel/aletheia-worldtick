...
SNIRF = Path(__file__).resolve().parent / "resources" / "synthetic" / "tape.snirf"
LOCK = "bloomlock"
N = 3
...
def main():
    ...
    rec = {
        ...
        "built": "official MNE reads SNIRF onsets [1,2,3] on S1_D1 and stim 1.0/2.0 at 1.0/2.0 s; empty SNIRF is absence",
        "theirs": theirs(),
        "ours": {
