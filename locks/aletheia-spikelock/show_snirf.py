...
SNIRF = Path(__file__).resolve().parent / "resources" / "synthetic" / "sub-01_task-spike.snirf"
LOCK = "spikelock"
N = 8
...
def main():
    ...
    rec = {
        ...
        "built": "official MNE reads 8 SNIRF samples on S1_D1 and stim 1.0/2.0 at 1.0/2.0 s; empty SNIRF is absence",
        "theirs": theirs(),
        "ours": {
