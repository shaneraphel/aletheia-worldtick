...
BOXY = Path(__file__).resolve().parent / "resources" / "synthetic" / "sub-01_task-spike.boxy"
LOCK = "spikelock"
N = 8
...
def main():
    ...
    rec = {
        ...
        "built": "official MNE reads 8 BOXY samples on S1_D1 DC and stim 1.0/2.0 at 1.0/2.0 s; empty BOXY is absence",
        "theirs": theirs(),
        "ours": {
