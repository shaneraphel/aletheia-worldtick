...
RAW = Path(__file__).resolve().parent / "resources" / "synthetic" / "sub-01_task-spike_egi.raw"
LOCK = "spikelock"
N = 8
...
def main():
    ...
    rec = {
        ...
        "built": "official MNE reads 8 EGI samples on E1 and DIN1/DIN2 at 1.0/2.0 s; empty EGI is absence",
        "theirs": theirs(),
        "ours": {
            "n": egi_occupancy(RAW),
