# Show: I used NumPy, and I refused the empty bloom tape

Aletheia is a compiled language model (`n_parameters=0`). This repo is what I
built with [numpy/numpy](https://github.com/numpy/numpy) on three blooms:
...
# Show: I used PhysioNet wfdb on the onset tape
