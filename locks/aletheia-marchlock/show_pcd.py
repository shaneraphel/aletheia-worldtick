...
def main():
    ...
    try:
        ...
        empty = "raised"
    rec = {
        "schema": "marchlock.show_pcd.v1",
        "used": "https://pointclouds.org/documentation/tutorials/pcd_file_format.html",
        "built": "five PCD contacts, Jarvis hull 4; empty cloud is absence",
        "ours": {"n": pcd_occupancy(PCD), "hull": jarvis_hull(pts), "empty": empty},
    ...
    if rec["ours"]["hull"] != 4 or rec["ours"]["empty"] != "raised":
        raise SystemExit("marchlock pcd show identity failed")
