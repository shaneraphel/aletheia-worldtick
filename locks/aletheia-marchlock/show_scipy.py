...
"""Use SciPy ConvexHull on Jarvis contacts. Record empty points. Refuse here."""
...
def ours() -> dict:
    ...
    try:
        ...
        pass
    return {"jarvis_hull": n, "empty": empty}


def main() -> int:
    rec = {
        "schema": "marchlock.show_scipy.v1",
        "used": "https://github.com/scipy/scipy",
        "built": "five-contact Jarvis hull 4; empty points are absence",
        "theirs": theirs(),
        "ours": ours(),
    ...
    if rec["ours"]["jarvis_hull"] != 4 or rec["ours"]["empty"] != "raised":
        raise SystemExit("marchlock show identity failed")
