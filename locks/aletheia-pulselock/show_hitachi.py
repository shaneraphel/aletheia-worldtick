...
CSV = Path(__file__).resolve().parent / "resources" / "synthetic" / "pulse_hitachi.csv"
LOCK = "pulselock"
N = 5
...
def main():
    ...
    rec = {
        ...
        "built": "official MNE reads Hitachi [1,2,3,-1,2] on S1_D1 695; empty Hitachi is absence",
        "theirs": theirs(),
        "ours": {
