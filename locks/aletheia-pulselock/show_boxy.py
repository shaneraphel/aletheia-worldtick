...
BOXY = Path(__file__).resolve().parent / "resources" / "synthetic" / "pulse.boxy"
LOCK = "pulselock"
N = 5
...
def main():
    ...
    rec = {
        ...
        "built": "official MNE reads BOXY [1,2,3,-1,2] on S1_D1 DC and stim 1.0/2.0 at 1.0/2.0 s; empty BOXY is absence",
        "theirs": theirs(),
        "ours": {
