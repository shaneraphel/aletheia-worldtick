...
RAW = Path(__file__).resolve().parent / "resources" / "synthetic" / "pulse_egi.raw"
LOCK = "pulselock"
N = 5
...
def main():
    ...
    rec = {
        ...
        "built": "official MNE reads EGI [1,2,3,-1,2] on E1 and DIN1/DIN2 at 1.0/2.0 s; empty EGI is absence",
        "theirs": theirs(),
        "ours": {
            "n": egi_occupancy(RAW),
