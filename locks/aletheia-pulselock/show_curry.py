...
DAP = Path(__file__).resolve().parent / "resources" / "synthetic" / "pulse_curry.dap"
LOCK = "pulselock"
N = 5
...
def main():
    ...
    rec = {
        ...
        "built": "official MNE reads Curry [1,2,3,-1,2] on Cz and event 1/2 at 1.0/2.0 s; empty Curry is absence",
        "theirs": theirs(),
        "ours": {
            "n": n,
